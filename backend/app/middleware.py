"""Compatibility shim: re-export middleware helpers from `backend.app.module.middleware`.
"""

from .module.middleware import setup_middleware, EnhancedCleanupMiddleware

__all__ = ["setup_middleware", "EnhancedCleanupMiddleware"]
